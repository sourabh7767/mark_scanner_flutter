              ...
              ListTile(
                onTap: () async {
                  ...
                  if (!permission) {
                    ...
                    print("compare : " + barcode.compareTo("1").toString());
                    if (barcode.compareTo("1") == 1) {
                      if (barcode.length == 17) {
                        code = barcode;
                      } else {
                        for (int i = 1; i < barcode.length; i++) {
                          code = (code ?? "") + barcode.characters.elementAt(i);
                        }
                      }
                        ...
                        return InkWell(
                          onTap: () {
                            Get.to(ServiceDetailScreen(
                                id: data.data!.data![index].id.toString()));
                          },
                          child: Container(
                            decoration: BoxDecoration(
          ...
          onTap: () async {
            ...
            if (!permission) {
              ...
              if (barcode.compareTo("1") == 1) {
                ...
                print('nothing return.' + (code ?? "").trim());
                print('nothing return.' + code.toString().length.toString());
                Get.to(ServicesRequest(
                  code: code ?? "",
                ));
              } else {
